...
//for the sphere size
        geometry.current = new SphereBufferGeometry(40, 50, 50);
       

        sphere.current = new Mesh(geometry.current, material.current);
        sphere.current.position.z = -40;
...
//when the mouse moves the sphere rotates
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            sphere.current.rotation.z += 0.006;
            renderer.current.render(scene.current, camera.current);
        };
